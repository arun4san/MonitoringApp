...
XPressIO.prototype.socketIOInitialize = function(){
    ...
    this.io.use(function(socket, next) {
        ...
        //console.log("SOCKETIO Handshake...", socket.id ," *** ",socket)
        ...
        try {
            ...
            if (! data.headers.cookie) {
                ...
                var requestQuery = url.parse(socket.handshake.url)
                var qs = queryString.parse(requestQuery.query);

                //return next(new Error('Missing cookie headers'));
                socket.handshake.sid = qs.UUID || socket.id;
                next();
                return;
            }
